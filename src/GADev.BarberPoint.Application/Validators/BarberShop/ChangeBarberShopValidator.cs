...
{
    public class ChangeBarberShopValidator : AbstractValidator<ChangeBarberShopCommand>
    {
        public ChangeBarberShopValidator()
        {
            RuleFor(a => a.Id)
           ...
           RuleFor(a => a.Name)
            ...
            RuleFor(a => a.IsActive)
                .NotNull().WithMessage("O campo 'IsActive não pode estar nulo'");
